...
const CARDS: TypeCardData[] = [
  ...
  { key: "bank", name: "Bank transaction", icon: CreditCard, status: "coming_soon",
    blurb: "Standalone bank movement — transfer, fee, FX deal.",
    comingHint: "Wires into the existing Bank Feed import + reconciliation flow." },
  { key: "general", name: "Regular journal", icon: NotebookPen, status: "ready",
    blurb: "Manual debit / credit lines. Reclass, accrual, adjustment." },
  { key: "intercompany", name: "Intercompany", icon: Network, status: "coming_soon",
    blurb: "Entry between two related entities — auto-mirrors the counter-leg.",
    comingHint: "Needs IC counterparty matching and the auto-mirror leg on the other entity." },
  ...
  { key: "payroll", name: "Payroll", icon: Users, status: "coming_soon",
    blurb: "Salary, employer contributions, social charges, withholding.",
    comingHint: "Needs the Payroll period model — not yet in the blueprint workbook." },
  ...
  { key: "accrual_prepayment", name: "Accrual / prepayment", icon: Hourglass, status: "coming_soon",
    blurb: "Multi-period split — defer prepaid, accrue what's earned but not invoiced.",
    comingHint: "Needs the rules registry + auto-amortisation we sketched for revenue recognition." },
  { key: "period_end", name: "Period-end adjustment", icon: CalendarCheck, status: "coming_soon",
    blurb: "FX revaluation, tax provision, reclass — anything that closes the books.",
    comingHint: "Needs the Period close workflow with auto-reversal of one-shot adjustments." },
