...
/* Workspace overview — formerly the home page.
 *
 * Per the UI philosophy doc (2026-05-10), the home screen is the
 * operational launcher (8 tiles), not a dashboard. The customizable
 * widget dashboard now lives behind the "Dashboard" tile.
 *
